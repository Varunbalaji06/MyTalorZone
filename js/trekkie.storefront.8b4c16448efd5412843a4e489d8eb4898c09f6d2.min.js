!(function () {
  var e = {
      ...
      1148: function (e, t, n) {
        ...
        function u() {
          ...
          for (const n of Object.keys(t))
            e[r.transformKeyToDisplayName(n)] =
              r.transformConsentToDisplaySchema(t[n]);
          return e;
        }
        function d(e, t) {
          ...
          (t.shopifyConsentAPI = function (e = { useBugsnagReporting: !1 }) {
            return (({ useBugsnagReporting: e }) => {
              ...
              const t = {
                ...
                marketingAllowed: s,
                firstPartyMarketingAllowed: s,
                saleOfDataAllowed: c,
                thirdPartyMarketingAllowed: c,
                currentVisitorConsent: u,
              ...
              for (const e in t)
                t.hasOwnProperty(e) &&
                  (t[e] = n.includes(e) ? t[e] : a.withBugsnag(t[e]));
              return t;
            })(e);
          });
      },
      ...
      5730: function (e, t, n) {
        ...
        function u() {
          return (
            r.marketingProcessingAllowed() && r.analyticsProcessingAllowed()
          );
        }
        function d() {
          return r.saleOfDataRegion()
        ...
        (t.saleOfDataRegion = r.saleOfDataRegion),
          ...
          (t.setCCPAConsent = function (e, t) {
            ...
            return i.storefrontApiUpdateTrackingConsent(
          ...
          (t.setTrackingConsent = function (e, t) {
            ...
            !0 === e || !1 === e
              ...
              : (n = e);
            const r = (function (e) {
                return e ? (c() ? document.referrer : "") : null;
              })(n.analytics),
              a = s(n.analytics);
            return i.storefrontApiUpdateTrackingConsent(
              {
          ...
          (t.shouldShowCCPABanner = function () {
            return (
              ...
              r.saleOfDataRegion() &&
                p() === o.DisplayConsentValues.NO_INTERACTION
            );
          }),
          (t.shouldShowGDPRBanner = function () {
            return (
              r.shouldShowBanner() &&
              a() === o.DisplayConsentValues.NO_INTERACTION
            );
          }),
          (t.userCanBeTracked = function () {
            return !!r.validCookieDoesNotExist() || u();
          }),
      ...
      8680: function (e, t, n) {
        ...
        function u(e) {
          ...
          return {
            query: `query { consentManagement { cookies(${a.objectToGraphQL(
              n
        ...
        t.storefrontApiUpdateTrackingConsent = function (e, t) {
          const n = e.granular_consent,
            ...
            d = n.checkoutRootDomain || window.location.host,
            p = n.isExtensionToken
              ? "Shopify-Storefront-Extension-Token"
              : "x-shopify-storefront-access-token",
            l = {
              headers: { "content-type": "application/json", [p]: a },
              body: JSON.stringify(u(e)),
              method: "POST",
            };
          return fetch(`https://${d}/api/unstable/graphql.json`, l)
            .then((e) => {
            ...
            .then((a) => {
              const u = 31536e6,
                ...
                h = a.data.consentManagement.cookies.landingPageCookie,
                g = a.data.consentManagement.cookies.origReferrerCookie;
              return (
                r.writeCookie(i.CONSENT_COOKIE_NAME, l, u, _),
                h &&
                  g &&
                  (r.writeCookie(s, l, d, h), r.writeCookie(c, l, d, g)),
                f !== l &&
                  (r.writeCookie(i.CONSENT_COOKIE_NAME, f, u, _),
                  h &&
                    g &&
                    (r.writeCookie(s, f, d, h), r.writeCookie(c, f, d, g))),
                o.dispatchEvents(e),
                void 0 !== t && t(null, a),
                a
              );
      ...
      9414: function (e, t, n) {
        ...
        (t.analyticsEvents = {
          ...
          storefrontApiAddedProduct:
            /^[ _]?storefront[ _]?[ _]?api[ _]?added[ _]?product[ _]?$/i,
        }),
      ...
      1482: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.storefrontAnalyticsSchemaId = "storefront_customer_tracking/4.17"),
          (t.storefrontAnalyticsSchemaIdValidation =
      ...
      3988: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.S2S =
            ...
            t.STOREFRONT_API_ADDED_PRODUCT_EVENT_NAME =
        ...
        (t.PAGE_RENDERED_EVENT_NAME = "page_rendered"),
          ...
          (t.STOREFRONT_API_ADDED_PRODUCT_EVENT_NAME =
            "test_storefront_api_added_product"),
                      ...
                      i(
                        {
                          ...
                          gdpr_enforced_as_string: c
                            ...
                            .toString(),
                          navigation_type:
                            null == a ? void 0 : a.navigationType,
                          ...
                          asset_version_id:
                            "8b4c16448efd5412843a4e489d8eb4898c09f6d2",
      ...
      3811: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.TREKKIE_PCIV4 =
            t.TREKKIE_GOOGLE_CONSENT_MODE_WITH_CONSENT_SIGNALS =
              void 0);
        var n = new ((function () {
          function e() {
            this.betaFlagsProps = [];
        ...
        (t.metricsSchemaId = "trekkie_metrics/2.0"),
          ...
          (t.sendToBugsnag = function (e) {
            ...
            if (this.shouldSendToBugsnag()) {
              var n = "8b4c16448efd5412843a4e489d8eb4898c09f6d2",
                o = null,
                r = null,
                i = null;
              if (e.appConfig)
            ...
            return (
              ...
              (e.prototype.logAssetContext = function (e) {
                ...
                a.addBatchEvent({
                  ...
                  payload: {
                    build_id: "8b4c16448efd5412843a4e489d8eb4898c09f6d2",
