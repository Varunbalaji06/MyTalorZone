!(function (e, t, o) {
  ...
  (r = function (e) {
    let t = function (e) {
      ...
      r = function (e, t, o) {
        ...
        r.setTime(r.getTime() + 1e3 * a),
          (document.cookie = e + "=" + t + ";expires=" + r.toGMTString());
      },
      a = function (e) {
        for (
          var t, o = document.cookie.replace(/[ ]/g, "").split(";"), r = 0;
          r < o.length;
          r++
        ) {
          var a = o[r].split("=");
      ...
      d = function () {
        ...
        (e.type = "text/css"),
          (e.innerHTML =
            ".delivery-widget__container > .msg__container p {margin: 0px;} .delivery-widget__container > .msg__container {white-space: break-spaces;}"),
          (e.id = "addStyle"),
      ...
      l = function () {
        let o =
          void 0 !==
          deliveryED.setting.delivery__app_setting.main_delivery_setting
        ...
        return (
          e.ajax({
            ...
            success: function (e) {
              let a = {
                country_code:
                  void 0 !== e.country_code
                    ? e.country_code.toLowerCase()
                    : "us",
                country_name:
                  void 0 !== e.country ? e.country : "United States",
                region_name: void 0 !== e.region ? e.region : "",
              };
              0 !== t(o) &&
                o.forEach((e, t) => {
                  String(e.lan_code) ===
                    String(deliveryCommon.setting.shop_locale_code__ed) &&
                    (a.country_name =
                      e.country_name_list[String(a.country_code)]);
                }),
                r.resolve(a);
            },
            error: function (a) {
              e.ajax({
                ...
                success: function (e) {
                  let a = {
                    country_code:
                      void 0 !== e.country ? e.country.toLowerCase() : "us",
                    country_name: void 0 !== e.name ? e.name : "United States",
                    region_name: "",
                  };
                  0 !== t(o) &&
                    o.forEach((e, t) => {
                    ...
                    success: function (e) {
                      ...
                      0 !== t(o) &&
                        o.forEach((e, t) => {
                          String(e.lan_code) ===
                            String(
                              deliveryCommon.setting.shop_locale_code__ed
                            ) &&
                            (a.country_name =
                              e.country_name_list[String(a.country_code)]);
                        }),
      ...
      s = function (e = "0") {
        if ("number" != typeof (e = parseFloat(e))) return;
        let t = new Date(),
          o = t.getTime(),
          r = 6e4 * t.getTimezoneOffset();
        return new Date(o + r + 36e5 * e);
      },
      p = function (
        e,
        t = 0,
        ...
        let i = ["Sun", "Mon", "Tues", "Wed", "Thur", "Fri", "Sat"],
          c = [];
        return (
          e.forEach((e, o) => {
            let _ = new Date(e.replace(/-/g, "/")).toDateString().split(" "),
              l = "th",
              s = Number(_[2]);
            s > 3 && s < 21
              ? (l = "th")
              : (s % 10 == 1 && (l = "st"),
                s % 10 == 2 && (l = "nd"),
                s % 10 == 3 && (l = "rd"));
            let p = new Date(e.replace(/-/g, "/")),
              u = p.getFullYear().toString().padStart(2, 0),
              m = (p.getMonth() + 1).toString().padStart(2, 0),
              g = p.getDate().toString().padStart(2, 0);
            switch (Number(t)) {
              case 0:
                c[o] = `${_[1]} ${_[2]}`;
                break;
              ...
              case 7:
                ...
                break;
              case 8:
                c[o] = `${i[p.getDay()]}, ${_[1]} ${_[2]} ${_[3]}`;
                break;
              case 9:
                c[o] = `${i[p.getDay()]}, ${_[1]} ${_[2]}${l} ${_[3]}`;
                break;
              case 10:
                c[o] = `${i[p.getDay()]}, ${_[2]} ${_[1]} ${_[3]}`;
                break;
              case 11:
                c[o] = `${i[p.getDay()]}, ${_[2]}${l} ${_[1]} ${_[3]}`;
                break;
              case 12:
                c[o] = `${i[p.getDay()]}, ${_[2]}${l} ${_[1]}`;
                break;
              case 13:
                c[o] = `${g}/${m}`;
                break;
              ...
              case 18:
                0 === Number(n) &&
                  ((m = String(Number(m))), (g = String(Number(g))));
                let e = r;
                (e = e.replace(/{year}/gi, u)),
                  (e = e.replace(/{month}/gi, m)),
                  (e = e.replace(/{day}/gi, g)),
                  (e = e.replace(/{day_advanced}/gi, g + l)),
                  (e = e.replace(/{month_local}/gi, a[p.getMonth()])),
                  (e = e.replace(/{week_local}/gi, d[p.getDay()])),
                  (c[o] = e);
            }
          }),
          c
      ...
      u = function (e, t, o = "-") {
        let r = new Date(new Date(e).valueOf() + 24 * t * 3600 * 1e3);
        return `${r.getFullYear().toString().padStart(2, 0)}${o}${(
          r.getMonth() + 1
        )
          .toString()
          .padStart(2, 0)}${o}${r.getDate().toString().padStart(2, 0)}`;
      },
      m = function (e, t, r, a = []) {
        ...
        if (0 === e)
          for (var n = 0; n <= 6; n++) {
            let d = new Date(
                new Date(r).valueOf() + 24 * n * 3600 * 1e3
              ).getDay(),
              i = "-",
              c = `${new Date(new Date(r).valueOf() + 24 * n * 3600 * 1e3)
                .getFullYear()
                .toString()
                .padStart(2, 0)}${i}${(
                new Date(
                ...
                .padStart(2, 0)}`,
              _ = o(c, a);
            if (!0 !== o(d, t) && !0 !== _) break;
            e += 1;
          }
        else
          for (var i = 1; i <= e; i++) {
            let n = new Date(
                new Date(r).valueOf() + 24 * i * 3600 * 1e3
              ).getDay(),
              c = "-",
              _ = `${new Date(new Date(r).valueOf() + 24 * i * 3600 * 1e3)
                .getFullYear()
                .toString()
                .padStart(2, 0)}${c}${(
                new Date(
      ...
      v = function (
        ...
        o,
        r = 0,
        a = "{hours} {hours_local} {minutes} {minutes_local} {seconds} {seconds_local}",
        ...
        (m < 0 || !0 === c || !0 === _) &&
          ...
          (m = p - l));
        let v = 1 === Number(n) ? "0" : "",
          b = Math.floor(m / 1e3 / 60 / 60 / 24),
          y = null;
        y =
          b >= 1
            ? Number(Math.floor((m / 1e3 / 60 / 60) % 24) + 24 * b)
            : Math.floor((m / 1e3 / 60 / 60) % 24) < 10
            ? v + Math.floor((m / 1e3 / 60 / 60) % 24)
            : Math.floor((m / 1e3 / 60 / 60) % 24);
        let h =
            Math.floor((m / 1e3 / 60) % 60) < 10
              ? v + Math.floor((m / 1e3 / 60) % 60)
              : Math.floor((m / 1e3 / 60) % 60),
          f =
            Math.floor((m / 1e3) % 60) < 10
              ? v + Math.floor((m / 1e3) % 60)
              : Math.floor((m / 1e3) % 60),
          x = "",
          w = null;
        if (16 === Number(r)) {
          let e = a;
          (e = e.replace(/{hours}/gi, y)),
            (e = e.replace(/{minutes}/gi, h)),
            (e = e.replace(/{seconds}/gi, f)),
            (e = e.replace(/{hours_local}/gi, d[0])),
            (e = e.replace(/{minutes_local}/gi, d[1])),
            (e = e.replace(/{seconds_local}/gi, d[2])),
            (x = e);
        } else
          (w = g(r)),
            3 === g(r).length
              ? (x = y + w[0] + " " + h + w[1] + " " + f + w[2])
              : 2 === g(r).length && (x = y + w[0] + " " + h + w[1]);
        return x;
      },
      b = function (e, t, r, a = []) {
        let d = 0;
        if (1 === r) {
          ...
          for (var n = 1; n <= 6; n++) {
            let r = new Date(
              new Date(e).valueOf() + 24 * n * 3600 * 1e3
            ).getDay();
            if (!0 !== o(r, t)) break;
            d += 1;
          }
          ...
          for (n = 1; n <= 200; n++) {
            let r = new Date(
              ...
              i = "-",
              c = `${new Date(new Date(e).valueOf() + 24 * n * 3600 * 1e3)
                .getFullYear()
                .toString()
                .padStart(2, 0)}${i}${(
                new Date(
                ...
                .padStart(2, 0)}`,
              _ = o(c, a);
            if (!0 !== o(r, t) && !0 !== _) break;
            d += 1;
          }
        return d;
      },
      y = function (e) {
        return `${new Date(new Date(e).valueOf())
          .getFullYear()
          .toString()
          .padStart(2, 0)}-${(new Date(new Date(e).valueOf()).getMonth() + 1)
          .toString()
          .padStart(2, 0)}-${new Date(new Date(e).valueOf())
          .getDate()
          .toString()
          .padStart(2, 0)}`;
      },
      h = function (e, t, o) {
        let r = e.getTime(),
          a = u(e, 0, "/") + " " + t + ":" + o + ":59";
        return new Date(a).getTime() > r ? 0 : 1;
      },
      f = function (e) {
        return {
          0: {
    ...
    (window._updateCountries__ed = {}), (window._timer__ed = null);
    let x = function (e, r) {
        let a =
            void 0 !==
            deliveryED.setting.delivery__app_setting.main_delivery_setting
        ...
        if (
          (0 !== t(a) &&
            a.forEach((e, t) => {
              String(e.lan_code) ===
                String(deliveryCommon.setting.shop_locale_code__ed) &&
                (d = e.country_name_list);
            }),
          1 === Number(e))
        ) {
          if (
            0 !== t(r) &&
            null !== deliveryED.setting.delivery__cate_setting
          ) {
            let e =
              deliveryED.setting.delivery__cate_setting
                .category_delivery_setting.country;
            Object.keys(d).map((t) => {
              !0 === o(t, r) &&
                0 === Number(e[t].widget_display_status) &&
                (_updateCountries__ed[t] = d[t]);
            });
          }
          d = _updateCountries__ed;
        }
        return d;
      },
      w = function () {
        let t = e(".trigger_ed").attr("data-code"),
          o = e(".trigger_ed").attr("data-name");
        e(".country-and-flag").html(
          '<span class="icon-' +
            t.toLowerCase() +
            '_f" style="display: inline-block; margin-right: 6px"></span><span>' +
            o +
            "</span>"
        ),
          e(".country-modal__delivery").addClass("show-modal__country-modal");
      },
      N = function () {
        let t = e(".trigger_ed").attr("data-code"),
          o = e(".trigger_ed").attr("data-name");
        e(".country-and-flag").html(
          ...
          e(".country-modal__delivery").removeClass(
            "show-modal__country-modal"
          );
      },
      k = {
        loadCountryHtml: function (t = 0, o = [], r = "") {
          let a = e(
            ".country-modal__delivery .content__country-modal .country__delivery .options"
          );
          a.html("");
          let d = x(t, o);
          Object.keys(d).map((e) => {
            let t = `<li onclick="_switchCountry__ed(this)" class="${
              d[e] == r ? "selected" : ""
            }" data-code="${e}" data-name="${
              d[e]
            }"><span class="icon-${e}_f" style="display: inline-block; margin-right: 6px"></span><span>${
              d[e]
            }</span></li>`;
            a.append(t);
          });
        ...
        windowOnClick: function (e) {
          e.target === document.querySelector(".country-modal__delivery") &&
            _removeToggleModal__ed();
        },
        switchCountry: function (a) {
          let d = a.getAttribute("data-code"),
            n = a.getAttribute("data-name");
          _removeToggleModal__ed();
          try {
            if (null !== deliveryED.setting.delivery__app_setting) {
              let a = deliveryED.setting.delivery__app_setting;
              if (0 !== t(a.main_delivery_setting)) {
                let c = a.main_delivery_setting,
                  _ = Number(c.is_active);
                if (
                  (1 ===
                    (void 0 !== c.is_ignore_out_of_stock
                      ? Number(c.is_ignore_out_of_stock)
                      : 0) &&
                    (deliveryCommon.setting.product_available__ed = "true"),
                  ("true" === deliveryCommon.setting.product_available__ed ||
                    0 ===
                      Number(
                        t(deliveryCommon.setting.product_available__ed)
                      )) &&
                    1 === _)
                ) {
                  let a = [
                    ...
                    _ = c.order_delivery_info,
                    l = Number(c.out_of_stock_mode),
                    g = c.out_of_stock_info,
                    x = Number(c.order_progress_bar_mode),
                    w = c.order_progress_setting,
                    N = c.order_delivery_work_week,
                    C = c.order_delivery_day_range,
                    z = Number(c.order_delivery_calc_method),
                    M = c.order_ready_work_week,
                    D = c.order_ready_day_range,
                    S = Number(c.order_ready_calc_method),
                    T = void 0 !== c.holiday ? c.holiday : [],
                    A = Number(c.order_delivery_date_format),
                    L = c.delivery_date_custom_format,
                    E =
                      void 0 !== c.delivery_date_format_zero
                        ? Number(c.delivery_date_format_zero)
                        : 1,
                    O = c.delivery_date_format_month_translate,
                    $ = c.delivery_date_format_week_translate,
                    B = Number(c.order_delivery_countdown_format),
                    H = c.delivery_countdown_custom_format,
                    j = c.countdown_format_translate,
                    q = Number(c.delivery_countdown_format_zero),
                    I = Number(c.countdown_cutoff_hour),
                    V = Number(c.countdown_cutoff_minute),
                    F =
                      void 0 !== c.countdown_cutoff_advanced_enable
                        ? Number(c.countdown_cutoff_advanced_enable)
                        : 0,
                    R =
                      void 0 !== c.countdown_cutoff_advanced
                    ...
                    G =
                      void 0 !== c.countdown_mode
                        ? Number(c.countdown_mode)
                        : 0,
                    P =
                      void 0 !== c.after_deadline_hide_widget
                        ? Number(c.after_deadline_hide_widget)
                        : 0,
                    U = Number(c.timezone_mode),
                    K = parseFloat(c.timezone),
                    Z =
                      void 0 !== c.todayandtomorrow
                        ? c.todayandtomorrow
                        : [
                            {
                              lan_code: "en",
                  ...
                  Z.forEach((e) => {
                    ...
                    (Y = !1 === J ? W : Q);
                  let X = Number(c.widget_layout_mode),
                    ee = Number(c.widget_placement_method),
                    te =
                      (Number(c.widget_placement_position),
                      Number(c.widget_placement_page)),
                    oe = c.widget_margin,
                    re = c.message_text_widget_appearance_setting,
                    ae = c.progress_bar_widget_appearance_setting,
                    de =
                      void 0 !== c.show_country_mode
                        ? Number(c.show_country_mode)
                        : 0,
                    ne =
                      void 0 !== c.arrow_down_position
                        ? Number(c.arrow_down_position)
                        : 0,
                    ie =
                      (void 0 !== c.country_modal_background_rgba &&
                        c.country_modal_background_rgba,
                      void 0 !== c.country_modal_appearance_setting &&
                        c.country_modal_appearance_setting,
                      void 0 !== c.cart_form_mode
                        ? Number(c.cart_form_mode)
                        : 0),
                    ce = Number(c.cart_form_position),
                    _e = Number(c.cart_checkout_status),
                    le = c.cart_checkout_title,
                    se = c.cart_checkout_description,
                    pe = (c.widget_custom_css, 0),
                    ue = 0,
                    me = 0,
                    ge = 1;
                  if (
                    ...
                    0 !==
                      Number(
                        t(
                          deliveryED.setting.delivery__cate_setting
                            .category_delivery_setting.category
                        )
                      )
                  ) {
                    let e =
                      deliveryED.setting.delivery__cate_setting
                        .category_delivery_setting.category;
                    if (1 === Number(e.is_add)) {
                      if (
                        ((pe = Number(e.widget_display_status)),
                        (ue = 1),
                        (_ = e.order_delivery_info),
                        (g = e.out_of_stock_info),
                        (l = Number(e.out_of_stock_mode)),
                        (x = Number(e.order_progress_bar_mode)),
                        (w = e.order_progress_setting),
                        (N = e.order_delivery_work_week),
                        (C = e.order_delivery_day_range),
                        (z = Number(e.order_delivery_calc_method)),
                        (M = e.order_ready_work_week),
                        (D = e.order_ready_day_range),
                        (S = Number(e.order_ready_calc_method)),
                        (T = void 0 !== e.holiday ? e.holiday : T),
                        (I =
                          void 0 !== e.countdown_cutoff_hour
                            ? e.countdown_cutoff_hour
                            : I),
                        (V =
                          void 0 !== e.countdown_cutoff_minute
                            ? e.countdown_cutoff_minute
                            : V),
                        (F =
                          void 0 !== e.countdown_cutoff_advanced_enable
                            ? e.countdown_cutoff_advanced_enable
                            : F),
                        (R =
                          void 0 !== e.countdown_cutoff_advanced
                            ? e.countdown_cutoff_advanced
                            : R),
                        (ge =
                          void 0 !== e.is_show_all_unadd_country
                            ? Number(e.is_show_all_unadd_country)
                            : 1),
                        (X = Number(e.widget_layout_mode)),
                        (_e = Number(e.cart_checkout_status)),
                        (le = e.cart_checkout_title),
                        (se = e.cart_checkout_description),
                        void 0 !==
                          deliveryED.setting.delivery__cate_setting
                            .category_delivery_setting.language &&
                          0 !==
                            Number(
                              t(
                                deliveryED.setting.delivery__cate_setting
                        ...
                        !0 ===
                          ...
                          ((_ =
                            e[deliveryCommon.setting.shop_locale_code__ed]
                              .order_delivery_info),
                          (g =
                            e[deliveryCommon.setting.shop_locale_code__ed]
                              .out_of_stock_info),
                          (w.ordered.title =
                            e[
                              deliveryCommon.setting.shop_locale_code__ed
                            ].order_progress_setting.ordered.title),
                          (w.ordered.tips_description =
                            e[
                              deliveryCommon.setting.shop_locale_code__ed
                            ].order_progress_setting.ordered.tips_description),
                          (w.order_ready.title =
                            e[
                              deliveryCommon.setting.shop_locale_code__ed
                            ].order_progress_setting.order_ready.title),
                          (w.order_ready.date_title =
                            e[
                              deliveryCommon.setting.shop_locale_code__ed
                            ].order_progress_setting.order_ready.date_title),
                          (w.order_ready.tips_description =
                            e[
                              deliveryCommon.setting.shop_locale_code__ed
                            ].order_progress_setting.order_ready.tips_description),
                          (w.order_delivered.title =
                            e[
                              deliveryCommon.setting.shop_locale_code__ed
                            ].order_progress_setting.order_delivered.title),
                          (w.order_delivered.date_title =
                            e[
                              deliveryCommon.setting.shop_locale_code__ed
                            ].order_progress_setting.order_delivered.date_title),
                          (w.order_delivered.tips_description =
                            e[
                              deliveryCommon.setting.shop_locale_code__ed
                            ].order_progress_setting.order_delivered.tips_description),
                          (L =
                            void 0 !==
                            e[deliveryCommon.setting.shop_locale_code__ed]
                              .delivery_date_custom_format
                              ? e[deliveryCommon.setting.shop_locale_code__ed]
                                  .delivery_date_custom_format
                              : L),
                          (O =
                            e[deliveryCommon.setting.shop_locale_code__ed]
                              .delivery_date_format_month_translate),
                          ($ =
                            e[deliveryCommon.setting.shop_locale_code__ed]
                              .delivery_date_format_week_translate),
                          (H =
                            void 0 !==
                            e[deliveryCommon.setting.shop_locale_code__ed]
                              .delivery_countdown_custom_format
                              ? e[deliveryCommon.setting.shop_locale_code__ed]
                                  .delivery_countdown_custom_format
                              : H),
                          (j =
                            e[deliveryCommon.setting.shop_locale_code__ed]
                              .countdown_format_translate),
                          (le =
                            e[deliveryCommon.setting.shop_locale_code__ed]
                              .cart_checkout_title),
                          (se =
                  ...
                  let ve = 0;
                  if (null !== deliveryED.setting.delivery__pro_setting) {
                    let e = deliveryED.setting.delivery__pro_setting;
                    if (0 !== t(e.product_delivery_setting)) {
                      let t = e.product_delivery_setting;
                      1 === Number(t.is_add) &&
                        ((pe = 1 === Number(t.widget_display_status) ? 1 : 0),
                        (ve = 1),
                        (_ = t.order_delivery_info),
                        (g = t.out_of_stock_info),
                        (l = Number(t.out_of_stock_mode)),
                        (x = Number(t.order_progress_bar_mode)),
                        (w = t.order_progress_setting),
                        (N = t.order_delivery_work_week),
                        (C = t.order_delivery_day_range),
                        (z = Number(t.order_delivery_calc_method)),
                        (M = t.order_ready_work_week),
                        (D = t.order_ready_day_range),
                        (S = Number(t.order_ready_calc_method)),
                        (T = void 0 !== t.holiday ? t.holiday : T),
                        (X = Number(t.widget_layout_mode)),
                        (_e = Number(t.cart_checkout_status)),
                        (le = t.cart_checkout_title),
                        (se = t.cart_checkout_description));
                    }
                  }
                  if (0 === pe) {
                    let c = "";
                    try {
                      !0 === window.navigator.cookieEnabled &&
                        (r("_delivery_app__country_code", d, 300),
                        r("_delivery_app__country_name", escape(n), 300),
                        r("_delivery_app__region_name", escape(c), 300));
                    } catch (e) {}
                    let l = 0;
                    if (1 === me && 1 === ue && 0 === ve) {
                      let e =
                        deliveryED.setting.delivery__cate_setting
                          .category_delivery_setting.country;
                      if (
                        (k.loadCountryHtml(de, Object.keys(e)),
                        !0 === o(d, Object.keys(e)))
                      ) {
                        (N = e[d].order_delivery_work_week),
                          (C = e[d].order_delivery_day_range),
                          (z = Number(e[d].order_delivery_calc_method)),
                          (M = e[d].order_ready_work_week),
                          (D = e[d].order_ready_day_range),
                          (S = Number(e[d].order_ready_calc_method)),
                          (T =
                            void 0 !== e[d].holiday && 0 !== t(e[d].holiday)
                              ? e[d].holiday
                              : T),
                          (l = Number(e[d].widget_display_status)),
                          (X = Number(e[d].widget_layout_mode)),
                          (_e = Number(e[d].cart_checkout_status));
                        let r = void 0 !== e[d].languages ? e[d].languages : [];
                        0 !== t(r) &&
                          !0 ===
                            o(
                              deliveryCommon.setting.shop_locale_code__ed,
                          ...
                          ((_ =
                            r[deliveryCommon.setting.shop_locale_code__ed]
                              .order_delivery_info),
                          (g =
                            r[deliveryCommon.setting.shop_locale_code__ed]
                              .out_of_stock_info),
                    ...
                    if (1 === l) return;
                    (_ = _.replace(/{country_name}/gi, n)),
                      (_ =
                        0 === Number(ne)
                          ? _.replace(
                              /{country_name_advanced}/gi,
                              '<a class="trigger_ed" data-code="' +
                                d +
                                '" data-name="' +
                                n +
                                '"><span style="display: inline-flex; justify-content: center; align-items: center; cursor: pointer;"><span>' +
                                n +
                                '</span><span style="padding-left: 2px;"><svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5661"><path d="M958.160991 320.247768 511.011998 766.80222 63.791373 320.247768l65.113997-65.098647L511.011998 636.748189l382.034996-381.599068L958.160991 320.247768" p-id="5662"></path></svg></span></span></a>'
                            )
                          : _.replace(
                              /{country_name_advanced}/gi,
                              '<a class="trigger_ed" data-code="' +
                                ...
                                '" data-name="' +
                                n +
                                '"><span style="display: inline-flex; justify-content: center; align-items: center; cursor: pointer;"><span style="padding-right: 2px;"><svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5661"><path d="M958.160991 320.247768 511.011998 766.80222 63.791373 320.247768l65.113997-65.098647L511.011998 636.748189l382.034996-381.599068L958.160991 320.247768" p-id="5662"></path></svg></span><span>' +
                                n +
                                "</span></span></a>"
                            )),
                      (_ = _.replace(/{region_name}/gi, c)),
                      (_ = _.replace(
                        /{country_flag}/gi,
                        '<span class="icon-' +
                          d +
                          '_f" style="display: inline-block;"></span>'
                      )),
                      (_ =
                        0 === Number(ne)
                          ? _.replace(
                              /{country_flag_advanced}/gi,
                              '<a class="trigger_ed" data-code="' +
                                d +
                                '" data-name="' +
                                n +
                                '"><span style="display: inline-flex; justify-content: center; align-items: center; cursor: pointer;"><span class="icon-' +
                                d +
                                '_f" style="display: inline-block;"></span><span style="padding-left: 2px;"><svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5661"><path d="M958.160991 320.247768 511.011998 766.80222 63.791373 320.247768l65.113997-65.098647L511.011998 636.748189l382.034996-381.599068L958.160991 320.247768" p-id="5662"></path></svg></span></span></a>'
                            )
                          : _.replace(
                              /{country_flag_advanced}/gi,
                              '<a class="trigger_ed" data-code="' +
                                ...
                                '" data-name="' +
                                n +
                                '"><span style="display: inline-flex; justify-content: center; align-items: center; cursor: pointer;"><span style="padding-right: 2px;"><svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5661"><path d="M958.160991 320.247768 511.011998 766.80222 63.791373 320.247768l65.113997-65.098647L511.011998 636.748189l382.034996-381.599068L958.160991 320.247768" p-id="5662"></path></svg></span><span class="icon-' +
                                d +
                                '_f" style="display: inline-block;"></span></span></a>'
                            ));
                    try {
                      let e = _.match(/{country_code_(.+?)_flag}/gi);
                      null !== e.length &&
                        e.forEach((e, t) => {
                          let o = e.slice(14, 16).toLowerCase();
                          _ = _.replace(
                            new RegExp("{country_code_" + o + "_flag}", "gm"),
                            '<span class="icon-' +
                              o +
                              '_f" style="display: inline-block;"></span>'
                          );
                    ...
                    try {
                      let e = _.match(/{svg_(.+?)_icon}/gi);
                      null !== e.length &&
                        e.forEach((e, t) => {
                          let o = Number(e.match(/\d+/gi)[0]);
                          _ = _.replace(
                            new RegExp("{svg_" + o + "_icon}", "gm"),
                            '<span class="message-icon__add" style="display: inline-flex;position: relative; top: 3px;"><svg class="svg__message-icon" style="color: #000000; font-size: 14px; width: 1.5em; height: 1.5em; display: inline-block;" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                              f(String(o)).svg_path +
                              "</svg></span>"
                          );
                        });
                    } catch (e) {}
                    let Z = 0 === Number(U) ? new Date() : s(K),
                      J = new Date(new Date(Z).valueOf()).getDay();
                    (I = 1 === Number(F) ? R[J][0] : I),
                      (V = 1 === Number(F) ? R[J][1] : V);
                    let W = !1;
                    1 === h(Z, I, V) &&
                      ((J = new Date(new Date(Z).valueOf() + 864e5).getDay()),
                      (I = 1 === Number(F) ? R[J][0] : I),
                      (V = 1 === Number(F) ? R[J][1] : V),
                      (W = !0));
                    let Q = h(Z, I, V);
                    0 === Number(Q) && !0 === W && (Q = 1),
                      0 === Number(G) &&
                        (_ =
                          1 === Q
                            ? _.replace(/{today_and_tomorrow}/gi, Y.right)
                            : _.replace(/{today_and_tomorrow}/gi, Y.left)),
                      -1 !== _.indexOf("{cutoff_time}") &&
                        (clearInterval(_timer__ed),
                        (_timer__ed = setInterval(function () {
                          let t = !1,
                            r = [],
                            a = 0;
                          (W = !1),
                            (Z = 0 === Number(U) ? new Date() : s(K)),
                            (J = new Date(new Date(Z).valueOf()).getDay()),
                            (I = 1 === Number(F) ? R[J][0] : I),
                            (V = 1 === Number(F) ? R[J][1] : V),
                            N.forEach((e, t) => {
                            ...
                            (1 !== h(Z, I, V) && !0 !== t) ||
                              ((J = new Date(
                                new Date(Z).valueOf() +
                                  24 * (Number(a) + 1) * 3600 * 1e3
                              ).getDay()),
                              (I = 1 === Number(F) ? R[J][0] : I),
                              (V = 1 === Number(F) ? R[J][1] : V),
                              (W = !0));
                          let d = v(Z, I, V, B, H, j, q, a, t, W);
                          e(".cutoff-time").html(d);
                        }, 1e3)),
                        (_ = _.replace(
                          /{cutoff_time}/gi,
                          '<span class="cutoff-time"></span>'
                        )));
                    let pe = [];
                    N.forEach((e, t) => {
                      0 === Number(e) && pe.push(t);
                    });
                    let be = new Date(Z.valueOf()).getDay(),
                      ye = o(be, pe);
                    if (
                      (2 === Number(G) && (ye = o(y(Z), T) || ye),
                      !0 !== ye ||
                        (0 !== Number(z) && 1 !== Number(z)) ||
                        (Q = 1),
                      (1 !== Number(G) && 2 !== Number(G)) ||
                        (_ =
                          1 === Q
                            ? _.replace(/{today_and_tomorrow}/gi, Y.right)
                            : _.replace(/{today_and_tomorrow}/gi, Y.left)),
                      ...
                      if (1 === Number(P)) {
                        let e = new Date(Z.valueOf()).getDay(),
                          t = 1 === Number(F) ? R[e][0] : I,
                          r = 1 === Number(F) ? R[e][1] : V;
                        if (1 === Number(G)) {
                          if (1 === h(Z, t, r)) {
                            let e = new Date(
                              new Date(Z).valueOf() + 864e5
                            ).getDay();
                            if (
                              !0 === o(e, pe) &&
                              (0 === Number(z) || 1 === Number(z))
                          ...
                          if (1 === h(Z, t, r)) {
                            ...
                            if (
                              ((t =
                                o(
                                  y(new Date(new Date(Z).valueOf() + 864e5)),
                                  T
                                ) || t),
                              !0 === t && (0 === Number(z) || 1 === Number(z)))
                            )
                              return;
                          } else {
                            let t = o(e, pe);
                    ...
                    let Ce = u(Z, 0),
                      ...
                      Me = [];
                    M.forEach((e, t) => {
                      0 === Number(e) && Me.push(t);
                    }),
                      (Q = h(Z, I, V)),
                      (ye = o(be, Me)),
                      2 === Number(G) && (ye = o(y(Z), T) || ye),
                      !0 !== ye ||
                        (0 !== Number(S) && 1 !== Number(S)) ||
                        (Q = 1);
                    let De = parseInt(D[0]),
                      Se = parseInt(D[1]),
                      Te = m(De + Q, Me, Z, T),
                    ...
                    0 === Number(S)
                      ...
                      : 2 === Number(S) &&
                        ...
                        (Le = u(Z, Se + Q)),
                        (Ee = p([Ae, Le], A, "-", L, O, $, E)));
                    let Oe = w.order_ready.date_title;
                    (Oe = Oe.replace(/{order_ready_minimum_date}/gi, Ee[0])),
                      (Oe = Oe.replace(/{order_ready_maximum_date}/gi, Ee[1]));
                    let $e = w.order_delivered.date_title,
                      Be = w.order_delivered.tips_description;
                    ($e = $e.replace(
                      /{order_delivered_minimum_date}/gi,
                      ke[0]
                    )),
                      ($e = $e.replace(
                        /{order_delivered_maximum_date}/gi,
                        ke[1]
                      )),
                      (Be = Be.replace(
                        /{order_delivered_minimum_date}/gi,
                      ...
                      (_ = _.replace(/{order_ready_minimum_date}/gi, Ee[0])),
                      (_ = _.replace(/{order_ready_maximum_date}/gi, Ee[1])),
                      (se = se.replace(
                        /{order_delivered_minimum_date}/gi,
                        ke[0]
                      )),
                      ...
                      (se = se.replace(/{order_ready_minimum_date}/gi, Ee[0])),
                      (se = se.replace(/{order_ready_maximum_date}/gi, Ee[1]));
                    let He =
                      '<div class="step-box__basic" style="background-color: ' +
                      ae.color.basic.icon_background_color +
                      ';">';
                    (He +=
                      '<div class="icon__step-box"><svg style="color: ' +
                      ae.color.basic.icon_color +
                      "; font-size: " +
                      ae.font.icon_font +
                      'px;" class="svg__icon" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                      f(String(w.ordered.svg_number)).svg_path +
                      "</svg></div>"),
                      (He +=
                        '<div class="content__step-box"><div class="title__content" style="color: ' +
                        ae.color.basic.order_status_title_color +
                        "; font-size: " +
                        ae.font.order_status_title_font +
                        'px;">' +
                        w.ordered.title +
                        '</div><div class="description__content" style="color: ' +
                        ae.color.basic.date_title_color +
                        "; font-size: " +
                        ae.font.date_title_font +
                        'px;">' +
                        ze[0] +
                        "</div></div>"),
                      (He += "</div>");
                    ...
                    (je +=
                      ...
                      ae.font.icon_font +
                      'px;" class="svg__icon" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                      f(String(w.order_ready.svg_number)).svg_path +
                      "</svg></div>"),
                      (je +=
                        '<div class="content__step-box"><div class="title__content" style="color: ' +
                        ae.color.basic.order_status_title_color +
                    ...
                    (qe +=
                      ...
                      ae.font.icon_font +
                      'px;" class="svg__icon" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                      f(String(w.order_delivered.svg_number)).svg_path +
                      "</svg></div>"),
                      (qe +=
                        '<div class="content__step-box"><div class="title__content" style="color: ' +
                        ae.color.basic.order_status_title_color +
                    ...
                    let Ie = "";
                    Ie =
                      1 === Number(w.order_ready.is_active)
                        ? '<div class="step__container" style="margin: ' +
                          Number(ae.other.margin[0]) +
                          "px " +
                          Number(ae.other.margin[1]) +
                          "px " +
                          Number(ae.other.margin[2]) +
                          "px " +
                          Number(ae.other.margin[3]) +
                          'px;"><div class="basic__step-container">' +
                          He +
                          je +
                          qe +
                          "</div></div>"
                        : '<div class="step__container" style="margin: ' +
                          ...
                          qe +
                          "</div></div>";
                    let Ve = '<div class="step-box__advanced">';
                    (Ve +=
                      '<span class="content-box__step-box ordered-content-box__step-box">'),
                      (Ve +=
                        '<span><div class="icon__content-box" style="background: ' +
                        ae.color.advanced.icon_background_color +
                        ';"><svg style="color: ' +
                        ae.color.advanced.icon_color +
                        "; font-size: " +
                        ae.font.icon_font +
                        'px;`" class="svg__icon" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                        f(String(w.ordered.svg_number)).svg_path +
                        "</svg></div></span>"),
                      (Ve +=
                        '<span class="sub-content__content-box"><span class="title__sub-content" style="text-align: left; color: ' +
                        ae.color.advanced.order_status_title_color +
                        "; font-size: " +
                        ae.font.order_status_title_font +
                        'px;">' +
                        w.ordered.title +
                        '</span><span class="date__sub-content date-left__sub-content" style="text-align: left;"><span style="position: relative; cursor: pointer;text-decoration: underline;text-decoration-style: dotted; color: ' +
                        ae.color.advanced.date_title_color +
                        "; font-size: " +
                        ae.font.date_title_font +
                        'px;">' +
                        ze[0] +
                        '<p style="color: ' +
                        ae.color.advanced.description_tips_color +
                        "; background-color: " +
                        ae.color.advanced.description_tips_background_color +
                        "; font-size: " +
                        ae.font.description_tips_font +
                        'px;">' +
                        w.ordered.tips_description +
                        "</p></span></span></span>"),
                      (Ve += "</span>"),
                      (Ve += "</div>");
                    let Fe = '<div class="step-box__advanced">';
                    1 === Number(w.order_ready.is_active)
                      ? (Fe +=
                          '<div class="line-box__step-box order-ready-line-box__step-box"><span style="background: ' +
                          ae.color.advanced.progress_line_color +
                          ';"></span></div>')
                      : (Fe +=
                          '<div style="left: calc(-100% + 65px) !important; right: calc(0% + 38px) !important;" class="line-box__step-box order-ready-line-box__step-box"><span style="background: ' +
                          ae.color.advanced.progress_line_color +
                          ';"></span></div>'),
                      (Fe +=
                      ...
                      1 === Number(w.order_ready.is_active) &&
                        ((Fe +=
                          ...
                          "</svg></div></span>"),
                        (Fe +=
                          '<span><span class="sub-content__content-box"><span class="title__sub-content" style="text-align: center; color: ' +
                          ae.color.advanced.order_status_title_color +
                          "; font-size: " +
                          ae.font.order_status_title_font +
                          'px;">' +
                          w.order_ready.title +
                          '</span><span class="date__sub-content date-center__sub-content" style="text-align: center;"><span style="position: relative; cursor: pointer;text-decoration: underline;text-decoration-style: dotted; color: ' +
                          ae.color.advanced.date_title_color +
                          "; font-size: " +
                          ae.font.date_title_font +
                          'px;">' +
                      ...
                      (Fe += "</span>"),
                      (Fe += "</div>");
                    let Re = '<div class="step-box__advanced">';
                    1 === Number(w.order_ready.is_active)
                      ? (Re +=
                          '<div class="line-box__step-box order-delivered-line-box__step-box"><span style="background: ' +
                          ae.color.advanced.progress_line_color +
                          ';"></span></div>')
                      : (Re +=
                          '<div style="left: calc(-100% + 38px) !important;" class="line-box__step-box order-delivered-line-box__step-box"><span style="background: ' +
                          ae.color.advanced.progress_line_color +
                          ';"></span></div>'),
                      (Re +=
                      ...
                      (Re +=
                        ...
                        "</svg></div></span>"),
                      (Re +=
                        '<span class="sub-content__content-box"><span class="title__sub-content" style="text-align: right; color: ' +
                        ae.color.advanced.order_status_title_color +
                        "; font-size: " +
                        ae.font.order_status_title_font +
                        'px;">' +
                        w.order_delivered.title +
                        '</span><span class="date__sub-content date-right__sub-content" style="text-align: right;"><span style="position: relative; cursor: pointer;text-decoration: underline;text-decoration-style: dotted; color: ' +
                        ae.color.advanced.date_title_color +
                        "; font-size: " +
                        ae.font.date_title_font +
                        'px;">' +
                    ...
                    let Ge =
                      ...
                      "px " +
                      Number(ae.other.margin[3]) +
                      'px;"><div class="advanced__step-container">' +
                      Ve +
                      Fe +
                      Re +
                      "</div></div>";
                    (_ =
                      '<div class="msg__container" style="border: ' +
                      Number(re.border.border_width) +
                      "px " +
                      a[Number(re.border.border_line)] +
                      " " +
                      re.color.border_color +
                      "; border-radius: " +
                      Number(re.border.border_radius) +
                      "px; color: " +
                      re.color.text_color +
                      "; background-color: " +
                      re.color.background_color +
                      "; margin: " +
                      Number(re.other.margin[0]) +
                      "px " +
                      Number(re.other.margin[1]) +
                      "px " +
                      Number(re.other.margin[2]) +
                      "px " +
                      Number(re.other.margin[3]) +
                      "px; padding: " +
                      Number(re.other.padding[0]) +
                      "px " +
                      Number(re.other.padding[1]) +
                      "px " +
                      Number(re.other.padding[2]) +
                      "px " +
                      Number(re.other.padding[3]) +
                      'px;">' +
                      _ +
                      "</div>"),
                      0 === Number(x)
                        ...
                        : 1 === Number(x) &&
                          (0 === Number(X)
                            ...
                            : 3 === Number(X) && (_ = Ge)),
                      (_ =
                        '<div class="delivery-widget__container" style="margin: ' +
                        oe[0] +
                        "px " +
                        oe[1] +
                        "px " +
                        ...
                        _ +
                        "</div>");
                    let Pe = ['form[action*="/cart/add"]'],
                      Ue = Array.from(document.querySelectorAll(Pe));
                    if (1 == e("product-form").length) {
                      let t = e("product-form").children(
                        'form[action*="/cart/add"]'
                      );
                      void 0 !== t[0] && (Ue = t);
                    }
                    if (
                      -1 !== window.location.href.indexOf("/products") &&
                      0 !== Ue.length &&
                      1 === _e
                    )
                      if (0 === ie)
                        e(Ue[ce]).prepend(
                          `<input type="hidden" class="delivery-hidden" name="properties[${le}]" value="${se}">`
                        );
                      else if (1 === ie) {
                        (Pe = ['form[action*="/cart/add"]']),
                          (Ue = Array.from(document.querySelectorAll(Pe)));
                        for (var i = 0; i <= Number(ce); i++)
                          e(Ue[i]).prepend(
                            `<input type="hidden" class="delivery-hidden" name="properties[${le}]" value="${se}">`
                          );
                      }
                    1 === te
                      ? 0 === ee &&
                        ...
                        ? 0 !==
                            ...
                            ).length && e(".delivery-widget__auto").html(_)
                        : 1 === ee &&
                          -1 !== window.location.href.indexOf("/products")
                        ? e(".delivery-widget__theme").html(_)
                        : 2 === ee &&
                          -1 !== window.location.href.indexOf("/products") &&
                          e(".delivery-widget__manual").html(_)
                      : 0 === ee
                      ? 0 !==
                          document.getElementsByClassName(
                            "delivery-widget__auto"
                      ...
                      : 1 === ee
                      ? e(".delivery-widget__theme").html(_)
                      : 2 === ee && e(".delivery-widget__manual").html(_);
                    let Ke = v(Z, I, V, B, H, j, q);
                    e(".cutoff-time").html(Ke);
                  }
                }
              }
            }
    ...
    (window._switchCountry__ed = k.switchCountry),
      (window._windowOnClick__ed = k.windowOnClick),
      (window._toggleModal__ed = w),
      (window._removeToggleModal__ed = N);
    try {
      if (null !== deliveryED.setting.delivery__app_setting) {
        let g = deliveryED.setting.delivery__app_setting;
        if (0 !== t(g.main_delivery_setting)) {
          let w = g.main_delivery_setting,
            N = Number(w.is_active);
          if (
            (1 ===
              (void 0 !== w.is_ignore_out_of_stock
                ? Number(w.is_ignore_out_of_stock)
                : 0) && (deliveryCommon.setting.product_available__ed = "true"),
            "true" === deliveryCommon.setting.product_available__ed ||
            ...
            if (1 === N) {
              let g = [
                ...
                N = w.order_delivery_info,
                z = Number(w.out_of_stock_mode),
                M = w.out_of_stock_info,
                D = Number(w.order_progress_bar_mode),
                S = w.order_progress_setting,
                T = w.order_delivery_work_week,
                A = w.order_delivery_day_range,
                L = Number(w.order_delivery_calc_method),
                E = w.order_ready_work_week,
                O = w.order_ready_day_range,
                $ = Number(w.order_ready_calc_method),
                B = void 0 !== w.holiday ? w.holiday : [],
                H = Number(w.order_delivery_date_format),
                j = w.delivery_date_custom_format,
                q =
                  void 0 !== w.delivery_date_format_zero
                    ? Number(w.delivery_date_format_zero)
                    : 1,
                I = w.delivery_date_format_month_translate,
                V = w.delivery_date_format_week_translate,
                F = Number(w.order_delivery_countdown_format),
                R = w.delivery_countdown_custom_format,
                G = w.countdown_format_translate,
                P = Number(w.delivery_countdown_format_zero),
                U = Number(w.countdown_cutoff_hour),
                K = Number(w.countdown_cutoff_minute),
                Z =
                  void 0 !== w.countdown_cutoff_advanced_enable
                    ? Number(w.countdown_cutoff_advanced_enable)
                    : 0,
                Y =
                  void 0 !== w.countdown_cutoff_advanced
                    ? w.countdown_cutoff_advanced
                    : [
                        [23, 59],
                        [23, 59],
                        [23, 59],
                ...
                J = void 0 !== w.countdown_mode ? Number(w.countdown_mode) : 0,
                W =
                  void 0 !== w.after_deadline_hide_widget
                    ? Number(w.after_deadline_hide_widget)
                    : 0,
                Q = Number(w.timezone_mode),
                X = parseFloat(w.timezone),
                ee =
                  void 0 !== w.todayandtomorrow
                    ? w.todayandtomorrow
                    : [
                        {
                          lan_code: "en",
              ...
              ee.forEach((e) => {
                "en" === e.lan_code && (re = e),
                  e.lan_code === deliveryCommon.setting.shop_locale_code__ed &&
                    ((ae = e), (oe = !0));
              }),
                (te = !1 === oe ? re : ae);
              let de = Number(w.widget_layout_mode),
                ne = Number(w.widget_placement_method),
                ie = Number(w.widget_placement_position),
                ce = Number(w.widget_placement_page),
                _e = w.widget_margin,
                le = w.message_text_widget_appearance_setting,
                se = w.progress_bar_widget_appearance_setting,
                pe =
                  void 0 !== w.show_country_mode
                    ? Number(w.show_country_mode)
                    : 0,
                ue =
                  void 0 !== w.arrow_down_position
                    ? Number(w.arrow_down_position)
                    : 0,
                me =
                  void 0 !== w.country_modal_background_rgba
                    ? w.country_modal_background_rgba
                    : [0, 0, 0, 0.5],
                ge =
                  void 0 !== w.country_modal_appearance_setting
                    ? w.country_modal_appearance_setting
                    : {
                        color: {
                          text_color: "#000000",
                          background_color: "#FFFFFF",
                          icon_color: "#999999",
                          selected_color: "#f2f2f2",
                        },
                        border: { border_radius: 7 },
                        font: { text_font: 16, icon_font: 16 },
                        other: { width: 56 },
                      },
                ve = void 0 !== w.cart_form_mode ? Number(w.cart_form_mode) : 0,
                be = Number(w.cart_form_position),
                ye =
                  void 0 !== w.product_form_position
                    ? Number(w.product_form_position)
                    : 0,
                he = Number(w.cart_checkout_status),
                fe = w.cart_checkout_title,
                xe = w.cart_checkout_description,
                we = w.widget_custom_css,
                Ne = void 0 !== w.is_show_all ? Number(w.is_show_all) : 1,
                ke = void 0 !== w.p_mapping ? Number(w.p_mapping) : 1000002,
                Ce = void 0 !== w.product_ids ? w.product_ids : [],
                ze = 0,
                Me = 0,
                De = 0,
                Se = 1;
              if (
                ...
                if (1 === Number(e.is_add)) {
                  if (
                    ((ze = Number(e.widget_display_status)),
                    (Me = 1),
                    (N = e.order_delivery_info),
                    (M = e.out_of_stock_info),
                    (z = Number(e.out_of_stock_mode)),
                    (D = Number(e.order_progress_bar_mode)),
                    (S = e.order_progress_setting),
                    (T = e.order_delivery_work_week),
                    (A = e.order_delivery_day_range),
                    (L = Number(e.order_delivery_calc_method)),
                    (E = e.order_ready_work_week),
                    (O = e.order_ready_day_range),
                    ($ = Number(e.order_ready_calc_method)),
                    (B = void 0 !== e.holiday ? e.holiday : B),
                    (U =
                      void 0 !== e.countdown_cutoff_hour
                        ? e.countdown_cutoff_hour
                        : U),
                    ...
                    (Se =
                      void 0 !== e.is_show_all_unadd_country
                        ? Number(e.is_show_all_unadd_country)
                        : 1),
                    (de = Number(e.widget_layout_mode)),
                    (he = Number(e.cart_checkout_status)),
                    (fe = e.cart_checkout_title),
                    (xe = e.cart_checkout_description),
                    void 0 !==
                      deliveryED.setting.delivery__cate_setting
                        .category_delivery_setting.language &&
                      0 !==
                    ...
                    !0 ===
                      ...
                      (S.order_ready.date_title =
                        e[
                          deliveryCommon.setting.shop_locale_code__ed
                        ].order_progress_setting.order_ready.date_title),
                      (S.order_ready.tips_description =
                        e[
                          deliveryCommon.setting.shop_locale_code__ed
                        ].order_progress_setting.order_ready.tips_description),
                      (S.order_delivered.title =
                        e[
                          deliveryCommon.setting.shop_locale_code__ed
                        ].order_progress_setting.order_delivered.title),
                      (S.order_delivered.date_title =
                        e[
                          deliveryCommon.setting.shop_locale_code__ed
                        ].order_progress_setting.order_delivered.date_title),
                      (S.order_delivered.tips_description =
                        e[
                          deliveryCommon.setting.shop_locale_code__ed
                        ].order_progress_setting.order_delivered.tips_description),
                      (j =
              ...
              if (null !== deliveryED.setting.delivery__pro_setting) {
                ...
                if (0 !== t(e.product_delivery_setting)) {
                  let t = e.product_delivery_setting;
                  1 === Number(t.is_add) &&
                    ((ze = 1 === Number(t.widget_display_status) ? 1 : 0),
                    (Te = 1),
                    (N = t.order_delivery_info),
                    (M = t.out_of_stock_info),
                    (z = Number(t.out_of_stock_mode)),
                    (D = Number(t.order_progress_bar_mode)),
                    (S = t.order_progress_setting),
                    (T = t.order_delivery_work_week),
                    (A = t.order_delivery_day_range),
                    (L = Number(t.order_delivery_calc_method)),
                    (E = t.order_ready_work_week),
                    (O = t.order_ready_day_range),
                    ($ = Number(t.order_ready_calc_method)),
                    (B = void 0 !== t.holiday ? t.holiday : B),
                    (de = Number(t.widget_layout_mode)),
                    (he = Number(t.cart_checkout_status)),
                    (fe = t.cart_checkout_title),
                    (xe = t.cart_checkout_description));
                }
              }
              if (0 === Ne && (11 === ke || 101 === ke) && 0 !== t(Ce)) {
                let e =
                  void 0 !== deliveryCommon.setting.product_id__ed
                    ? deliveryCommon.setting.product_id__ed
                    : "";
                if (0 !== t(e) && !1 === o(e, Ce)) return;
              }
              if (0 === ze) {
                if (
                  (-1 !== N.indexOf("{country_name_advanced}") ||
                    -1 !== N.indexOf("{country_flag_advanced}")) &&
                  -1 !== window.location.href.indexOf("/products")
                ) {
                  e(".country-modal__delivery").remove();
                  let t =
                    '<div class="country-modal__delivery" style="background-color: rgba(' +
                    me[0] +
                    ", " +
                    me[1] +
                    ", " +
                    ...
                    ", " +
                    me[3] +
                    ')"><div class="content__country-modal"><div class="country__delivery"><div class="select-btn" style="background: ' +
                    ge.color.background_color +
                    "; border-radius: " +
                    ge.border.border_radius +
                    'px;"><span class="country-and-flag" style="display: inline-flex;align-items: center;justify-content: center; color: ' +
                    ge.color.text_color +
                    "; font-size: " +
                    ge.font.text_font +
                    'px;"></span><span class="country-angle-down" style="color: ' +
                    ge.color.icon_color +
                    "; font-size: " +
                    ge.font.icon_font +
                    'px;"><svg class="icon" style="width: 1em;height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5661"><path d="M958.160991 320.247768 511.011998 766.80222 63.791373 320.247768l65.113997-65.098647L511.011998 636.748189l382.034996-381.599068L958.160991 320.247768" p-id="5662"></path></svg></span></div><div class="content" style="background: ' +
                    ge.color.background_color +
                    "; border-radius: " +
                    ge.border.border_radius +
                    'px;"><div class="search"><span class="content-search" style="color: ' +
                    ge.color.icon_color +
                    "; font-size: " +
                    ge.font.icon_font +
                    ...
                    ge.color.background_color +
                    ';"></div><ul class="options" style="color: ' +
                    ge.color.text_color +
                    ';"></ul></div></div></div></div>';
                  e("body").append(t);
                  const o = e(
                      ".country-modal__delivery .content__country-modal .country__delivery"
                    ),
                    r = e(
                      ".country-modal__delivery .content__country-modal .country__delivery .select-btn"
                    ),
                    a = e(
                      ".country-modal__delivery .content__country-modal .country__delivery input"
                    ),
                    d = e(
                      ".country-modal__delivery .content__country-modal .country__delivery .options"
                    );
                  k.loadCountryHtml(pe);
                  try {
                    e(document).on("keyup", a, (e) => {
                      if (
                        "country-delivery__input" ===
                        ...
                        let e = [],
                          t = a.val().toLowerCase(),
                          o = x(pe, _updateCountries__ed);
                        (e = Object.keys(o)
                          .filter(
                            (e) =>
                              o[e].toLowerCase().startsWith(t) ||
                              e.toLowerCase().startsWith(t)
                          )
                          .map(
                            (e) =>
                              `<li onclick="_switchCountry__ed(this)" data-code="${e}" data-name="${o[e]}"><span class="icon-${e}_f" style="display: inline-block; margin-right: 6px"></span><span>${o[e]}</span></li>`
                          )
                          .join("")),
                          d.html(e);
                      }
                      ...
                      e(document)
                        .off("click", ".trigger_ed")
                        .on("click", ".trigger_ed", _toggleModal__ed),
                      window.addEventListener("click", _windowOnClick__ed);
                  } catch (e) {}
                }
                if (
                  (d(),
                ...
                let w = "us",
                  ...
                  ee = "California";
                if (
                  void 0 !== a("_delivery_app__country_code") &&
                  void 0 !== a("_delivery_app__country_name") &&
                  void 0 !== a("_delivery_app__region_name")
                ) {
                  (w = a("_delivery_app__country_code")),
                    (z = unescape(a("_delivery_app__country_name"))),
                    (ee = unescape(a("_delivery_app__region_name")));
                  let r = 0;
                  if (1 === De && 1 === Me && 0 === Te) {
                    let e =
                      deliveryED.setting.delivery__cate_setting
                        .category_delivery_setting.country;
                    if (
                      (k.loadCountryHtml(pe, Object.keys(e)),
                      !0 === o(w, Object.keys(e)))
                    ) {
                      (T = e[w].order_delivery_work_week),
                        (A = e[w].order_delivery_day_range),
                        (L = Number(e[w].order_delivery_calc_method)),
                        (E = e[w].order_ready_work_week),
                        (O = e[w].order_ready_day_range),
                        ($ = Number(e[w].order_ready_calc_method)),
                        (B =
                          void 0 !== e[w].holiday && 0 !== t(e[w].holiday)
                            ? e[w].holiday
                            : B),
                        (r = Number(e[w].widget_display_status)),
                        (de = Number(e[w].widget_layout_mode)),
                        (he = Number(e[w].cart_checkout_status));
                      let a = void 0 !== e[w].languages ? e[w].languages : [];
                      0 !== t(a) &&
                        !0 ===
                          o(
                            deliveryCommon.setting.shop_locale_code__ed,
                        ...
                        ((N =
                          a[deliveryCommon.setting.shop_locale_code__ed]
                            .order_delivery_info),
                        (M =
                          a[deliveryCommon.setting.shop_locale_code__ed]
                            .out_of_stock_info),
                  ...
                  try {
                    let e = N.match(/{country_code_(.+?)_flag}/gi);
                    null !== e.length &&
                      e.forEach((e, t) => {
                        let o = e.slice(14, 16).toLowerCase();
                        N = N.replace(
                  ...
                  let d = 0 === Number(Q) ? new Date() : s(X),
                    n = new Date(new Date(d).valueOf()).getDay();
                  (U = 1 === Number(Z) ? Y[n][0] : U),
                    (K = 1 === Number(Z) ? Y[n][1] : K);
                  let i = !1;
                  1 === h(d, U, K) &&
                    ((n = new Date(new Date(d).valueOf() + 864e5).getDay()),
                    (U = 1 === Number(Z) ? Y[n][0] : U),
                    (K = 1 === Number(Z) ? Y[n][1] : K),
                    (i = !0));
                  let c = h(d, U, K);
                  0 === Number(c) && !0 === i && (c = 1),
                    0 === Number(J) &&
                      (N =
                        1 === c
                          ? N.replace(/{today_and_tomorrow}/gi, te.right)
                          : N.replace(/{today_and_tomorrow}/gi, te.left)),
                    -1 !== N.indexOf("{cutoff_time}") &&
                      (clearInterval(_timer__ed),
                      (_timer__ed = setInterval(function () {
                        let t = !1,
                          r = [],
                        ...
                        (i = !1),
                          ...
                          (1 !== h(d, U, K) && !0 !== t) ||
                            ...
                            (K = 1 === Number(Z) ? Y[n][1] : K),
                            (i = !0));
                        let c = v(d, U, K, F, R, G, P, a, t, i);
                        e(".cutoff-time").html(c);
                      }, 1e3)),
                      (N = N.replace(
                        /{cutoff_time}/gi,
                        '<span class="cutoff-time"></span>'
                  ...
                  let l = new Date(d.valueOf()).getDay(),
                    x = o(l, _);
                  if (
                    (2 === Number(J) && (x = o(y(d), B) || x),
                    !0 !== x || (0 !== Number(L) && 1 !== Number(L)) || (c = 1),
                    (1 !== Number(J) && 2 !== Number(J)) ||
                      (N =
                        1 === c
                          ? N.replace(/{today_and_tomorrow}/gi, te.right)
                          : N.replace(/{today_and_tomorrow}/gi, te.left)),
                    ...
                    if (1 === Number(W)) {
                      let e = new Date(d.valueOf()).getDay(),
                        t = 1 === Number(Z) ? Y[e][0] : U,
                        r = 1 === Number(Z) ? Y[e][1] : K;
                      if (1 === Number(J)) {
                        if (1 === h(d, t, r)) {
                          let e = new Date(
                            new Date(d).valueOf() + 864e5
                          ).getDay();
                          if (
                            !0 === o(e, _) &&
                            (0 === Number(L) || 1 === Number(L))
                          )
                            return;
                        } else if (
                          !0 === o(e, _) &&
                        ...
                        if (1 === h(d, t, r)) {
                          ...
                          if (
                            ((t =
                              o(
                                y(new Date(new Date(d).valueOf() + 864e5)),
                                B
                              ) || t),
                            !0 === t && (0 === Number(L) || 1 === Number(L)))
                          )
                            return;
                        } else {
                          let t = o(e, _);
                  ...
                  let Ne = u(d, 0),
                    ...
                    Ce = [];
                  E.forEach((e, t) => {
                    0 === Number(e) && Ce.push(t);
                  }),
                    (c = h(d, U, K)),
                    (x = o(l, Ce)),
                    2 === Number(J) && (x = o(y(d), B) || x),
                    !0 !== x || (0 !== Number($) && 1 !== Number($)) || (c = 1);
                  let ze = parseInt(O[0]),
                    Ae = parseInt(O[1]),
                    Le = m(ze + c, Ce, d, B),
                    Ee = "",
                  ...
                  0 === Number($)
                    ...
                    : 2 === Number($) &&
                      ...
                      (Oe = u(d, Ae + c)),
                      ($e = p([Ee, Oe], H, "-", j, I, V, q)));
                  let Be = S.order_ready.date_title;
                  (Be = Be.replace(/{order_ready_minimum_date}/gi, $e[0])),
                    (Be = Be.replace(/{order_ready_maximum_date}/gi, $e[1]));
                  let He = S.order_delivered.date_title,
                    je = S.order_delivered.tips_description;
                  (He = He.replace(/{order_delivered_minimum_date}/gi, we[0])),
                    (He = He.replace(
                      /{order_delivered_maximum_date}/gi,
                      we[1]
                    )),
                    ...
                    (N = N.replace(/{order_delivered_minimum_date}/gi, we[0])),
                    (N = N.replace(/{order_delivered_maximum_date}/gi, we[1])),
                    (N = N.replace(/{order_ready_minimum_date}/gi, $e[0])),
                    (N = N.replace(/{order_ready_maximum_date}/gi, $e[1])),
                    (xe = xe.replace(
                      /{order_delivered_minimum_date}/gi,
                      we[0]
                    )),
                    ...
                    (xe = xe.replace(/{order_ready_minimum_date}/gi, $e[0])),
                    (xe = xe.replace(/{order_ready_maximum_date}/gi, $e[1]));
                  let qe =
                    '<div class="step-box__basic" style="background-color: ' +
                    se.color.basic.icon_background_color +
                    ';">';
                  (qe +=
                    '<div class="icon__step-box"><svg style="color: ' +
                    se.color.basic.icon_color +
                    "; font-size: " +
                    se.font.icon_font +
                    'px;" class="svg__icon" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                    f(String(S.ordered.svg_number)).svg_path +
                    "</svg></div>"),
                    (qe +=
                      '<div class="content__step-box"><div class="title__content" style="color: ' +
                      se.color.basic.order_status_title_color +
                      "; font-size: " +
                      se.font.order_status_title_font +
                      'px;">' +
                      S.ordered.title +
                      '</div><div class="description__content" style="color: ' +
                      se.color.basic.date_title_color +
                      "; font-size: " +
                      se.font.date_title_font +
                      'px;">' +
                      ke[0] +
                      "</div></div>"),
                    (qe += "</div>");
                  ...
                  (Ie +=
                    ...
                    se.font.icon_font +
                    'px;" class="svg__icon" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                    f(String(S.order_ready.svg_number)).svg_path +
                    "</svg></div>"),
                    (Ie +=
                      '<div class="content__step-box"><div class="title__content" style="color: ' +
                      se.color.basic.order_status_title_color +
                  ...
                  (Ve +=
                    ...
                    se.font.icon_font +
                    'px;" class="svg__icon" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                    f(String(S.order_delivered.svg_number)).svg_path +
                    "</svg></div>"),
                    (Ve +=
                      '<div class="content__step-box"><div class="title__content" style="color: ' +
                      se.color.basic.order_status_title_color +
                  ...
                  let Fe = "";
                  Fe =
                    1 === Number(S.order_ready.is_active)
                      ? '<div class="step__container" style="margin: ' +
                        Number(se.other.margin[0]) +
                        "px " +
                        Number(se.other.margin[1]) +
                        "px " +
                        Number(se.other.margin[2]) +
                        "px " +
                        Number(se.other.margin[3]) +
                        'px;"><div class="basic__step-container">' +
                        qe +
                        Ie +
                        Ve +
                  ...
                  (Re +=
                    ...
                    (Re +=
                      '<span><div class="icon__content-box" style="background: ' +
                      se.color.advanced.icon_background_color +
                      ';"><svg style="color: ' +
                      se.color.advanced.icon_color +
                      "; font-size: " +
                      se.font.icon_font +
                      'px;`" class="svg__icon" focusable="false" viewBox="0 0 1024 1024" aria-hidden="true">' +
                      f(String(S.ordered.svg_number)).svg_path +
                    ...
                    (Re +=
                      '<span class="sub-content__content-box"><span class="title__sub-content" style="text-align: left; color: ' +
                      se.color.advanced.order_status_title_color +
                      "; font-size: " +
                      se.font.order_status_title_font +
                      'px;">' +
                      S.ordered.title +
                      '</span><span class="date__sub-content date-left__sub-content" style="text-align: left;"><span style="position: relative; cursor: pointer;text-decoration: underline;text-decoration-style: dotted; color: ' +
                      se.color.advanced.date_title_color +
                      "; font-size: " +
                      se.font.date_title_font +
                      'px;">' +
                      ke[0] +
                      '<p style="color: ' +
                      se.color.advanced.description_tips_color +
                      "; background-color: " +
                      se.color.advanced.description_tips_background_color +
                      "; font-size: " +
                      se.font.description_tips_font +
                      'px;">' +
                      S.ordered.tips_description +
                      "</p></span></span></span>"),
                    (Re += "</span>"),
                    (Re += "</div>");
                  let Ge = '<div class="step-box__advanced">';
                  1 === Number(S.order_ready.is_active)
                    ? (Ge +=
                        '<div class="line-box__step-box order-ready-line-box__step-box"><span style="background: ' +
                        se.color.advanced.progress_line_color +
                        ';"></span></div>')
                    : (Ge +=
                        '<div style="left: calc(-100% + 65px) !important; right: calc(0% + 38px) !important;" class="line-box__step-box order-ready-line-box__step-box"><span style="background: ' +
                        se.color.advanced.progress_line_color +
                    ...
                    (Ge += "</span>"),
                    (Ge += "</div>");
                  let Pe = '<div class="step-box__advanced">';
                  1 === Number(S.order_ready.is_active)
                    ? (Pe +=
                        '<div class="line-box__step-box order-delivered-line-box__step-box"><span style="background: ' +
                        se.color.advanced.progress_line_color +
                  ...
                  (N =
                    '<div class="msg__container" style="border: ' +
                    Number(le.border.border_width) +
                    "px " +
                    g[Number(le.border.border_line)] +
                    " " +
                    le.color.border_color +
                    "; border-radius: " +
                    Number(le.border.border_radius) +
                    "px; color: " +
                    le.color.text_color +
                    "; background-color: " +
                    le.color.background_color +
                    "; margin: " +
                    Number(le.other.margin[0]) +
                    "px " +
                    Number(le.other.margin[1]) +
                    "px " +
                    Number(le.other.margin[2]) +
                    "px " +
                    Number(le.other.margin[3]) +
                    "px; padding: " +
                    Number(le.other.padding[0]) +
                    "px " +
                    Number(le.other.padding[1]) +
                    "px " +
                    Number(le.other.padding[2]) +
                    "px " +
                    Number(le.other.padding[3]) +
                    'px;">' +
                    N +
                    "</div>"),
                    0 === Number(D)
                    ...
                    (N =
                      ...
                      N +
                      "</div>");
                  let Ke = ['form[action*="/cart/add"]'],
                    Ze = Array.from(document.querySelectorAll(Ke));
                  if (1 == e("product-form").length) {
                    let t = e("product-form").children(
                      'form[action*="/cart/add"]'
                    );
                  ...
                  if (
                    ...
                    if (0 === ve)
                      e(Ze[be]).prepend(
                        `<input type="hidden" class="delivery-hidden" name="properties[${fe}]" value="${xe}">`
                      );
                    else if (1 === ve) {
                      (Ke = ['form[action*="/cart/add"]']),
                        (Ze = Array.from(document.querySelectorAll(Ke)));
                      for (var C = 0; C <= Number(be); C++)
                        e(Ze[C]).prepend(
                          `<input type="hidden" class="delivery-hidden" name="properties[${fe}]" value="${xe}">`
                        );
                    }
                  if (1 === ce)
                    if (
                      ...
                      if (
                        0 ===
                        document.getElementsByClassName("delivery-widget__auto")
                          .length
                      )
                        if (0 === ie)
                          0 !== Ze.length &&
                          ...
                          let t = [
                              ...
                              .join(", "),
                            o = Array.from(document.querySelectorAll(t));
                          0 === o.length
                            ? e(o[ye]).before(
                                '<div class="delivery-widget__auto">' +
                                  N +
                      ...
                      1 === ne &&
                      -1 !== window.location.href.indexOf("/products")
                        ? e(".delivery-widget__theme").html(N)
                        : 2 === ne &&
                          -1 !== window.location.href.indexOf("/products") &&
                          e(".delivery-widget__manual").html(N);
                  else if (0 === ne) {
                    if (
                      0 ===
                      document.getElementsByClassName("delivery-widget__auto")
                      ...
                      if (0 === ie)
                        0 !== Ze.length &&
                          e(Ze[ye]).after(
                            '<div class="delivery-widget__auto">' + N + "</div>"
                          );
                      else {
                        let t = [
                            ".add-to-cart",
                    ...
                    1 === ne
                      ? e(".delivery-widget__theme").html(N)
                      : 2 === ne && e(".delivery-widget__manual").html(N);
                  let Ye = v(d, U, K, F, R, G, P);
                  e(".cutoff-time").html(Ye);
                } else
                  e.when(l())
                    .done(function (a) {
                      (w = a.country_code.toLowerCase()),
                        (z = a.country_name),
                        (ee = a.region_name),
                        2 === w.length &&
                          ((w = a.country_code.toLowerCase()),
                      ...
                      try {
                        !0 === window.navigator.cookieEnabled &&
                          (r("_delivery_app__country_code", w, 300),
                          r("_delivery_app__country_name", escape(z), 300),
                          r("_delivery_app__region_name", escape(ee), 300));
                      } catch (e) {}
                      let d = 0;
                      if (1 === De && 1 === Me && 0 === Te) {
                        let e =
                          ...
                          (T = e[w].order_delivery_work_week),
                            ...
                            (B =
                              void 0 !== e[w].holiday && 0 !== t(e[w].holiday)
                                ? e[w].holiday
                                : B),
                            (d = Number(e[w].widget_display_status)),
                            (de = Number(e[w].widget_layout_mode)),
                            (he = Number(e[w].cart_checkout_status));
                          let r =
                            void 0 !== e[w].languages ? e[w].languages : [];
                          0 !== t(r) &&
                            !0 ===
                              o(
                                deliveryCommon.setting.shop_locale_code__ed,
                      ...
                      let n = 0 === Number(Q) ? new Date() : s(X),
                        i = new Date(new Date(n).valueOf()).getDay();
                      (U = 1 === Number(Z) ? Y[i][0] : U),
                        (K = 1 === Number(Z) ? Y[i][1] : K);
                      let c = !1;
                      1 === h(n, U, K) &&
                        ((i = new Date(new Date(n).valueOf() + 864e5).getDay()),
                        (U = 1 === Number(Z) ? Y[i][0] : U),
                        (K = 1 === Number(Z) ? Y[i][1] : K),
                        (c = !0));
                      let _ = h(n, U, K);
                      ...
                      let x = new Date(n.valueOf()).getDay(),
                        C = o(x, l);
                      if (
                        (2 === Number(J) && (C = o(y(n), B) || C),
                        !0 !== C ||
                          (0 !== Number(L) && 1 !== Number(L)) ||
                          (_ = 1),
                        (1 !== Number(J) && 2 !== Number(J)) ||
                        ...
                        if (1 === Number(W)) {
                          let e = new Date(n.valueOf()).getDay(),
                            t = 1 === Number(Z) ? Y[e][0] : U,
                            r = 1 === Number(Z) ? Y[e][1] : K;
                          if (1 === Number(J)) {
                            if (1 === h(n, t, r)) {
                            ...
                            if (1 === h(n, t, r)) {
                              ...
                              if (
                                ((t =
                                  o(
                                    y(new Date(new Date(n).valueOf() + 864e5)),
                                    B
                                  ) || t),
                                !0 === t &&
                                  (0 === Number(L) || 1 === Number(L)))
                      ...
                      if (1 === ce)
                        if (
                          ...
                          -1 !== window.location.href.indexOf("/products")
                            ...
                            : 2 === ne &&
                              -1 !==
                                window.location.href.indexOf("/products") &&
                              e(".delivery-widget__manual").html(N);
                      else if (0 === ne) {
                        if (
                          0 ===
                        ...
                        1 === ne
                          ? e(".delivery-widget__theme").html(N)
                          : 2 === ne && e(".delivery-widget__manual").html(N);
                      let Je = v(n, U, K, F, R, G, P);
                      e(".cutoff-time").html(Je);
                    })
                    .fail(function () {
                      let r = 0;
                      if (1 === De && 1 === Me && 0 === Te) {
                      ...
                      let a = 0 === Number(Q) ? new Date() : s(X),
                        d = new Date(new Date(a).valueOf()).getDay();
                      (U = 1 === Number(Z) ? Y[d][0] : U),
                        (K = 1 === Number(Z) ? Y[d][1] : K);
                      let n = !1;
                      1 === h(a, U, K) &&
                        ((d = new Date(new Date(a).valueOf() + 864e5).getDay()),
                        (U = 1 === Number(Z) ? Y[d][0] : U),
                        (K = 1 === Number(Z) ? Y[d][1] : K),
                        (n = !0));
                      let i = h(a, U, K);
                          ...
                          (_timer__ed = setInterval(function () {
                            ...
                            (n = !1),
                              ...
                              (1 !== h(a, U, K) && !0 !== t) ||
                                ((d = new Date(
                                  new Date(a).valueOf() +
                                    24 * (Number(i) + 1) * 3600 * 1e3
                                ).getDay()),
                                (U = 1 === Number(Z) ? Y[d][0] : U),
                                (K = 1 === Number(Z) ? Y[d][1] : K),
                                (n = !0));
                            let c = v(a, U, K, F, R, G, P, i, t, n);
                            e(".cutoff-time").html(c);
                          }, 1e3)),
                          (N = N.replace(
                            /{cutoff_time}/gi,
                      ...
                      let _ = new Date(a.valueOf()).getDay(),
                        l = o(_, c);
                      if (
                        (2 === Number(J) && (l = o(y(a), B) || l),
                        !0 !== l ||
                          (0 !== Number(L) && 1 !== Number(L)) ||
                          (i = 1),
                        (1 !== Number(J) && 2 !== Number(J)) ||
                        ...
                        if (1 === Number(W)) {
                          let e = new Date(a.valueOf()).getDay(),
                            t = 1 === Number(Z) ? Y[e][0] : U,
                            r = 1 === Number(Z) ? Y[e][1] : K;
                          if (1 === Number(J)) {
                            if (1 === h(a, t, r)) {
                            ...
                            if (1 === h(a, t, r)) {
                              ...
                              if (
                                ((t =
                                  o(
                                    y(new Date(new Date(a).valueOf() + 864e5)),
                                    B
                                  ) || t),
                                !0 === t &&
                                  (0 === Number(L) || 1 === Number(L)))
                      ...
                      0 === Number($)
                        ? ((Ae = u(a, ze)),
                          (Le = u(a, m(Ce + i, Ne, a, B))),
                          (Ee = p([Ae, Le], H, "-", j, I, V, q)))
                        : 1 === Number($)
                        ? ((Ae = u(a, ze)),
                          (Le = u(a, ze + (Ce - ke) + i)),
                          (Ee = p([Ae, Le], H, "-", j, I, V, q)))
                        : 2 === Number($) &&
                          ...
                          (Le = u(a, Ce + i)),
                          (Ee = p([Ae, Le], H, "-", j, I, V, q)));
                      let Oe = S.order_ready.date_title;
                      (Oe = Oe.replace(/{order_ready_minimum_date}/gi, Ee[0])),
                        (Oe = Oe.replace(
                          /{order_ready_maximum_date}/gi,
                          Ee[1]
                        ));
                      let $e = S.order_delivered.date_title,
                        Be = S.order_delivered.tips_description;
                      ($e = $e.replace(
                        /{order_delivered_minimum_date}/gi,
                        me[0]
                      )),
                        ...
                        (N = N.replace(/{order_ready_minimum_date}/gi, Ee[0])),
                        (N = N.replace(/{order_ready_maximum_date}/gi, Ee[1])),
                        (xe = xe.replace(
                          /{order_delivered_minimum_date}/gi,
                          me[0]
                        )),
                      ...
                      if (1 === ce)
                        ...
                        1 === ne
                          ? e(".delivery-widget__theme").html(N)
                          : 2 === ne && e(".delivery-widget__manual").html(N);
                      let Ze = v(a, U, K, F, R, G, P);
                      e(".cutoff-time").html(Ze);
                    });
              }
            }
          } else if ("false" === deliveryCommon.setting.product_available__ed) {
            let r = [
                "none",
                "solid",
                "dotted",
              ...
              a = w.order_delivery_info,
              i = Number(w.out_of_stock_mode),
              c = w.out_of_stock_info,
              _ = Number(w.order_progress_bar_mode),
              l = w.order_progress_setting,
              s = w.order_delivery_work_week,
              p = w.order_delivery_day_range,
              u = Number(w.order_delivery_calc_method),
              m = w.order_ready_work_week,
              g = w.order_ready_day_range,
              v = Number(w.order_ready_calc_method),
              b =
                (Number(w.order_delivery_date_format),
                w.delivery_date_custom_format),
              y = w.delivery_date_format_month_translate,
              h = w.delivery_date_format_week_translate,
              f =
                (Number(w.order_delivery_countdown_format),
                w.delivery_countdown_custom_format),
              x = w.countdown_format_translate,
              k =
                (Number(w.delivery_countdown_format_zero),
                Number(w.countdown_cutoff_hour),
                Number(w.countdown_cutoff_minute),
                Number(w.timezone_mode),
                parseFloat(w.timezone),
                Number(w.widget_layout_mode)),
              C = Number(w.widget_placement_method),
              z = Number(w.widget_placement_position),
              M = Number(w.widget_placement_page),
              D = w.widget_margin,
              S = w.message_text_widget_appearance_setting,
              T =
                (w.progress_bar_widget_appearance_setting,
                Number(w.cart_form_position),
                void 0 !== w.out_of_stock_product_form_position
                  ? Number(w.out_of_stock_product_form_position)
                  : 0),
              A = Number(w.cart_checkout_status),
              L = w.cart_checkout_title,
              E = w.cart_checkout_description,
              O = w.widget_custom_css,
              $ = 0,
              B = 0,
              H = 0;
            if (
              ...
              if (1 === Number(e.is_add)) {
                if (
                  (($ = Number(e.widget_display_status)),
                  (B = 1),
                  (a = e.order_delivery_info),
                  (c = e.out_of_stock_info),
                  (i = Number(e.out_of_stock_mode)),
                  (_ = Number(e.order_progress_bar_mode)),
                  (l = e.order_progress_setting),
                  (s = e.order_delivery_work_week),
                  (p = e.order_delivery_day_range),
                  (u = Number(e.order_delivery_calc_method)),
                  (m = e.order_ready_work_week),
                  (g = e.order_ready_day_range),
                  (v = Number(e.order_ready_calc_method)),
                  (k = Number(e.widget_layout_mode)),
                  (A = Number(e.cart_checkout_status)),
                  (L = e.cart_checkout_title),
                  (E = e.cart_checkout_description),
                  void 0 !==
                    deliveryED.setting.delivery__cate_setting
                      .category_delivery_setting.language &&
                    0 !==
                  ...
                  !0 ===
                    ...
                    (l.order_ready.date_title =
                      e[
                        deliveryCommon.setting.shop_locale_code__ed
                      ].order_progress_setting.order_ready.date_title),
                    (l.order_ready.tips_description =
                      e[
                        deliveryCommon.setting.shop_locale_code__ed
                      ].order_progress_setting.order_ready.tips_description),
                    (l.order_delivered.title =
                      e[
                        deliveryCommon.setting.shop_locale_code__ed
                      ].order_progress_setting.order_delivered.title),
                    (l.order_delivered.date_title =
                      e[
                        deliveryCommon.setting.shop_locale_code__ed
                      ].order_progress_setting.order_delivered.date_title),
                    (l.order_delivered.tips_description =
                      e[
                        deliveryCommon.setting.shop_locale_code__ed
                      ].order_progress_setting.order_delivered.tips_description),
                    (b =
            ...
            if (null !== deliveryED.setting.delivery__pro_setting) {
              ...
              if (0 !== t(e.product_delivery_setting)) {
                let t = e.product_delivery_setting;
                1 === Number(t.is_add) &&
                  (($ = 1 === Number(t.widget_display_status) ? 1 : 0),
                  (i = 1 === Number(t.out_of_stock_mode) ? 1 : 0),
                  (j = 1),
                  (a = t.order_delivery_info),
                  (c = t.out_of_stock_info),
                  (_ = Number(t.order_progress_bar_mode)),
                  (l = t.order_progress_setting),
                  (s = t.order_delivery_work_week),
                  (p = t.order_delivery_day_range),
                  (u = Number(t.order_delivery_calc_method)),
                  (m = t.order_ready_work_week),
                  (g = t.order_ready_day_range),
                  (v = Number(t.order_ready_calc_method)),
                  (k = Number(t.widget_layout_mode)),
                  (A = Number(t.cart_checkout_status)),
                  (L = t.cart_checkout_title),
                  (E = t.cart_checkout_description));
              }
            }
            if (1 === N && 0 === $ && 1 === i) {
              d(),
                ...
                (a =
                  '<div class="msg__container" style="border: ' +
                  Number(S.border.border_width) +
                  "px " +
                  r[Number(S.border.border_line)] +
                  " " +
                  S.color.border_color +
                  "; border-radius: " +
                  Number(S.border.border_radius) +
                  "px; color: " +
                  S.color.text_color +
                  "; background-color: " +
                  S.color.background_color +
                  "; margin: " +
                  Number(S.other.margin[0]) +
                  "px " +
                  Number(S.other.margin[1]) +
                  "px " +
                  Number(S.other.margin[2]) +
                  "px " +
                  Number(S.other.margin[3]) +
                  "px; padding: " +
                  Number(S.other.padding[0]) +
                  "px " +
                  Number(S.other.padding[1]) +
                  "px " +
                  Number(S.other.padding[2]) +
                  "px " +
                  Number(S.other.padding[3]) +
                  'px;">' +
                  c +
                  "</div>"),
                (a =
                  ...
                  a +
                  "</div>");
              let t = ['form[action*="/cart/add"]'],
                o = Array.from(document.querySelectorAll(t));
              if (1 == e("product-form").length) {
                let t = e("product-form").children('form[action*="/cart/add"]');
                void 0 !== t[0] && (o = t);
              }
              if (1 === M)
                if (
                  ...
                  if (
                    ...
                    if (0 === z)
                      0 !== o.length &&
                        e(o[T]).after(
                          '<div class="delivery-widget__auto">' + a + "</div>"
                        );
                    else {
                      let t = [
                          ".add-to-cart",
                  ...
                  1 === C && -1 !== window.location.href.indexOf("/products")
                    ? e(".delivery-widget__theme").html(a)
                    : 2 === C &&
                      -1 !== window.location.href.indexOf("/products") &&
                      e(".delivery-widget__manual").html(a);
              else if (0 === C) {
                if (
                  0 ===
                  document.getElementsByClassName("delivery-widget__auto")
                ...
                1 === C
                  ? e(".delivery-widget__theme").html(a)
                  : 2 === C && e(".delivery-widget__manual").html(a);
            }
          }
        }
      }
    ...
    "undefined" == typeof jQuery || parseFloat(jQuery.fn.jquery) < 1
      ? (function (e) {
