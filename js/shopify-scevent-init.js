          ...
          var t = {
            ...
            loadSha256Script: function () {
              ...
              return new Promise(function (e) {
                ...
                (n.async = !0),
                  (n.src = "https://sc-static.net/js-sha256-v1.min.js"),
                  "integrity" in n &&
                    "crossOrigin" in n &&
                    ((n.integrity =
                      "sha384-W4RqaNUbvBdTRc41QQAWDcd2aX9wGruak2WnlXwyjVAlhi56zatCk4e/RSqwrAg6"),
            ...
            getCurrentScript: function () {
              ...
              if (!t)
                for (
                  var e = document.getElementsByTagName("script"), r = 0;
                  r < e.length;
                  r++
                )
                  if (
            ...
            scrapeInitMeta: function () {
              ...
              try {
                var e = window.Shopify.checkout,
                  r =
                    e.phone ||
                    (e.shipping_address && e.shipping_address.phone) ||
                    (e.billing_address && e.billing_address.phone),
                  n = !!r && r.replace(/[^0-9]/g, ""),
                  o = e.email;
                          ...
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (
                                ...
                                (e.prev = 1),
                                (e.next = 4),
                                this.loadSha256Script()
                              );
                            case 4:
                              (o = e.sent),
                                (i = t.getCurrentScript()),
                                (a = t.getUrlParameters(i.src).id),
                                (c = n.user_email ? o(n.user_email) : ""),
                                (u = n.user_phone_number
                                  ? o(n.user_phone_number)
                                  : ""),
                                (s = t.read1stPartyCookie("_scid")),
                                window.snaptr("init", a, n),
                                fetch("https://tr.snapchat.com/scs/shopify", {
                                  method: "POST",
                                  body: "pid="
                                    .concat(a, "&u_hem=")
                                    .concat(c, "&u_hpn=")
