!(function () {
  ...
  var e,
    ...
    v = function (e) {
      "hidden" === document.visibilityState &&
        g > -1 &&
        ((g = "visibilitychange" === e.type ? e.timeStamp : 0), S());
    },
    y = function () {
              ...
              e.forEach(function (e) {
                "first-contentful-paint" === e.name &&
                  ...
                  e.startTime < r.firstHiddenTime &&
                    ((o.value = Math.max(e.startTime - c(), 0)),
                    o.entries.push(e),
                    n(!0)));
              });
            });
  ...
  var U;
  function J({ monorailRegion: e, schema: t, rawData: n }) {
    const r = Date.now(),
      o = {
        schema_id: t,
        payload:
            ...
            : ((i = n),
              {
                ...
                interaction_to_next_paint_target:
                  i.interactionToNextPaintTarget,
                seo_bot: i.seoBot,
    ...
    try {
      ...
      if (
        ...
        (function () {
          ...
          return (
            -1 !== e.lastIndexOf("iPhone; CPU iPhone OS 12_") ||
            -1 !== e.lastIndexOf("iPad; CPU OS 12_")
          );
        })()
      ) {
        ...
        const e = new window.Blob([JSON.stringify(o)], { type: "text/plain" });
  ...
  function K(e) {
    const t = [
      ...
      return (
        e[n] &&
          (t[((r = n), r.replace(/[A-Z]/g, (e) => `_${e.toLowerCase()}`))] =
            e[n] || null),
        t
      );
    }, {});
    return {
      ...
      first_interim_response_start: e.firstInterimResponseStart,
      final_response_headers_start: e.finalResponseHeadersStart,
  ...
  !(function (e) {
    (e.OnInteraction = "perf_kit_on_interaction/3.0"),
      (e.OnUnload = "perf_kit_on_unload/3.2");
  })(U || (U = {}));
        ...
        (this.performanceMetrics = (function (e) {
          ...
          return (
            ((n.requestStart && n.startTime && n.requestStart < n.startTime) ||
              ...
              (n.responseEnd && n.responseEnd > e + 864e5)) &&
              (r = !0),
            {
              ...
              navigationBad: r,
              firstInterimResponseStart: Math.round(
                n.firstInterimResponseStart
              ),
              finalResponseHeadersStart: Math.round(
                n.finalResponseHeadersStart
              ),
  ...
  function re() {
    if (null !== Y) {
      if (ae() && ne.size > 0) {
        let e = {};
        for (const t of ne) e = { ...e, ...t };
        ne.clear(), (Y.info.microSessionCount += 1);
        const t = (function (e) {
          if (!(100 * Math.random() > (e || j)))
            return performance.getEntriesByType("resource").map((e) => {
              const t = Object.entries(e.toJSON()).map(([e, t]) =>
                "number" == typeof t ? [e, Math.round(t)] : [e, t]
              );
  ...
  (oe = function (e) {
        ...
        (t = t || {}),
          _(function () {
            var n,
              ...
              i = function (e) {
                ...
                t &&
                  ...
                  ((o.value = Math.max(t.startTime - c(), 0)),
                  (o.entries = [t]),
                  n());
              },
            ...
            if (a) {
              ...
              var g = p(function () {
                A[o.id] ||
                  (i(a.takeRecords()), a.disconnect(), (A[o.id] = !0), n(!0));
              });
    ...
    (function (e, r) {
      ...
      const { value: t } = e;
      ne.add({ firstContentfulPaint: Math.round(t) });
    }),
    (function (e, t) {
      !(function (e, t) {
        (t = t || {}),
          _(function () {
            ...
            var r,
              ...
              i = function (e) {
                ...
                var t,
                  n =
                    ((t = Math.min(N.length - 1, Math.floor(B() / 50))), N[t]);
                n &&
                  n.latency !== o.value &&
    ...
    (function (e, t) {
      ...
      const { value: t } = e;
      ne.add({ timeToFirstByte: Math.round(t) });
    }),
    ...
    (function () {
      ...
      try {
        (t = (function (e) {
          ...
          if (
            !["storefront-renderer", "hydrogen"].includes(
              e.application.toLowerCase()
            )
          )
          ...
          if (
            ...
            !["shop_domain", "global", "staging", "canada"].includes(
              e.monorailRegion.toLowerCase()
            )
          )
            throw new Error("Invalid monorail region");
          if (
            e.resourceTimingSamplingRate &&
            (isNaN(Number(e.resourceTimingSamplingRate)) ||
              Number(e.resourceTimingSamplingRate) < j ||
              Number(e.resourceTimingSamplingRate) > 100)
          )
          ...
          return {
            ...
            resourceTimingSamplingRate:
              Number(e.resourceTimingSamplingRate) || void 0,
